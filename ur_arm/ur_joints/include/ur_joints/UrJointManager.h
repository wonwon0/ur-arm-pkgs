#ifndef UR_JOINTS_URJOINTMANAGER_H
#define UR_JOINTS_URJOINTMANAGER_H
 ...
 * \date January 2016
 */
class UrJointManager: public arm_components_name_manager::ArmComponentsNameManager
{
public:
    /**
     ...
     */
    UrJointManager(const std::string& robot_namespace="ur", bool readParams=true);
    UrJointManager(const UrJointManager& o);
...
#endif  // UR_JOINTS_URJOINTMANAGER_H
